...
$sql = mysqli_query($db, "SELECT * FROM pengaduan WHERE status='proses'");
...
<div class="center-text">
    ...
    if(isset($_GET['url'])) {
        ...
        echo "Anda login sebagai Petugas: ".(isset($_SESSION['nama_petugas']) ? $_SESSION['nama_petugas'] : 'Tidak Diketahui')."<br>";
